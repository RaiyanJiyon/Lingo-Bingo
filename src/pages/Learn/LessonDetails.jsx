...
const LessonDetails = () => {
    ...
    return (
        <div className="mt-8">
            <Helmet>
                <title>Lesson Details | Lingo Bingo</title>
            </Helmet>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8">
                {lesson.map(vocabulary => (
                    <div key={vocabulary.id} onClick={() => pronounceWord(vocabulary.word)} className="card bg-base-100 shadow-xl transition-transform duration-300 ease-in-out transform hover:scale-110">
